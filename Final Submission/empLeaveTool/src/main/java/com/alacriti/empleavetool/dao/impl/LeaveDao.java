...
public class LeaveDao extends BaseDao {
	...
	public boolean leaveApproveDao(LeaveVo leavevo) throws DAOException,
		...
		System.out.println("In Leave Dao empId from leavevo "
				+ leavevo.getEmpId());
		empvo = empdao.empInfoResult(empId);
		PreparedStatement preparedStatement = null;

		System.out.println("In Leave Dao leave Balance using empvo "
				+ empvo.getLeaveBalance());

		boolean flag = false;

		try {
			conn = getConnection();
			int updateLeave = (empvo.getLeaveBalance() - leavevo.getNoDays());
			System.out.println("In Leave Dao leave Status "
			...
			System.out
					.println("In Leave Dao leave Days " + leavevo.getNoDays());
	...
	public boolean cancelLeave(LeaveVo leavevo) throws DAOException,
		...
		try {
			...
			System.out.println("In Cancel Status " + leavevo.getLeaveStatus());
