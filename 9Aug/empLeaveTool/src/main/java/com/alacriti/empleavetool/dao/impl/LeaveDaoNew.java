...
public class LeaveDaoNew extends BaseDao {
...
//		System.out.println("Email :" + empvo.getEmpId());
//		System.out.println("F name:" + empvo.getfName());
//		System.out.println("M Name :" + empvo.getmName());
//		System.out.println("last :" + empvo.getlName());
//		System.out.println("Gender :" + empvo.getGender());
//		System.out.println("Contact :" + empvo.getContactNo());
//		System.out.println("Leave BAlance :" + empvo.getLeaveBalance());
//		System.out.println("Empid_profile :" + empvo.getEmpId());
//		System.out.println("Email :" + empvo.getEmail());
//		System.out
//				.println("Check What the PAssword is :" + empvo.getPassWord());
//		System.out.println("Emp Status :" + empvo.getEmpStatus());
//		System.out.println("Ques :" + empvo.getQuestionId());
//		System.out.println("Answer :" + empvo.getAnswer());
		return empvo;
